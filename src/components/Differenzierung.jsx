function Differenzierung() {
  const features = [
    ...
    },
    {
      ...
      description: 'Alles verschlüsselt, alles in der Schweiz. Ihr Treuhänder wird zufrieden sein.',
      icon: (
        <svg className="w-5 h-5 text-accent-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="differenzierung" className="py-16 md:py-24 bg-slate-950 text-white">
